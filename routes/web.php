...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('/public/information/add', 'PublicInfoController@postAddPublicInfo')->name('post.add.public.info');

	// All public info
	Route::get('/all/public/information', 'PublicInfoController@all')->name('all.public.info');

	// view public info 
	Route::get('/public/information/view/{id}', 'PublicInfoController@viewPublicInfo')->name('view.public.info');
	...
	// view activity
	Route::get('/previous/activity/{id}', 'PublicInfoController@viewPreviousActivity')->name('view.previous.activity');


	// Add Image in Preivious Activities
	Route::get('/previous/activity/add/get', 'PublicInfoController@addPreviousActivityImage')->name('add.previous.activity.image');
