  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <p>
            <a href="{{ route('previous.activities') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back to Previous Activities</a>
                ...
                <div class="col-md-6">   
                  ...
                  <form action="" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{ route('previous.activities') }}" class="btn btn-danger"><i class="fa fa-ban"></i> Cancel</a>
                    </div>
                  </form>
                </div>
              </div>
