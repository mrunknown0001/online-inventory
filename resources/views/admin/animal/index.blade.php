...
@section('title') Animal Management @endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Animal Management</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <p>
            <a href="{{ route('add.animal') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Animal</a>
          </p>
          <!-- TABLE: LATEST ORDERS -->
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="animals" class="table table-striped table-bordered" style="width: 99%">
                  <thead>
                    <tr>
                      <th>Animal</th>
                      <th>Species</th>
