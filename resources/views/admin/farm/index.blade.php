...
@section('title') Farm Management @endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <p>
            <a href="{{ route('add.farm') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Farm</a>
          </p>
          <!-- TABLE: LATEST ORDERS -->
...
<script>
  ...
  $(document).on('click', '#view', function (e) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          // update
          window.location.replace("/admin/farm/info/" + id);
        }
        else {
          Swal.fire({
            title: 'View Farm Info Cancelled',
            text: "",
            type: 'info',
    ...
    $(document).on('click', '#update', function (e) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          Swal.fire({
            title: 'Update Farm Info Cancelled',
            text: "",
            type: 'info',
            showCancelButton: false,
            confirmButtonColor: '#3085d6',
