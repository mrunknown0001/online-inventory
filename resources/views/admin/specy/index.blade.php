...
@section('title') Specy Management @endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Species Management</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <p>
            <a href="{{ route('add.species') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Species</a>
          </p>
          <!-- TABLE: LATEST ORDERS -->
...
<script>
  ...
  $(document).on('click', '#view', function (e) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          // update
          window.location.replace("/admin/species/info/" + id);
        }
        else {
          Swal.fire({
            title: 'View Species Info Cancelled',
            text: "",
            type: 'info',
    ...
    $(document).on('click', '#update', function (e) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          Swal.fire({
            title: 'Update Species Info Cancelled',
            text: "",
            type: 'info',
            showCancelButton: false,
            confirmButtonColor: '#3085d6',
