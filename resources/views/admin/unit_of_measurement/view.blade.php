  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <p>
            <a href="{{ route('unit.of.measurements') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back to Unit of Measurement</a>
          </p>
          <!-- TABLE: LATEST ORDERS -->
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <p>Unit: <strong>{{ $unit->name }}</strong></p>
                  <p>Code: <strong>{{ $unit->code }}</strong></p>
                </div>
              </div>
            </div>
            <!-- /.box-body -->
