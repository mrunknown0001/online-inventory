...
@section('title') Supplier Management @endsection
...
<script>
  ...
  $(document).on('click', '#view', function (e) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          // update
          window.location.replace("/admin/supplier/info/" + id);
        }
        else {
          Swal.fire({
            title: 'View Supplier Info Cancelled',
            text: "",
            type: 'info',
    ...
    $(document).on('click', '#update', function (e) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          Swal.fire({
            title: 'Update Supplier Info Cancelled',
            text: "",
            type: 'info',
            showCancelButton: false,
            confirmButtonColor: '#3085d6',
